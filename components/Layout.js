  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="title"
          content="An Airbnb like mordern web application for finding homes"
        />
            ...
            <div className="h-full px-4 flex justify-between items-center space-x-4">
              <Link href="/">
                <a className="flex items-center space-x-1">
                  <SearchIcon className="shrink-0 w-8 h-8 text-cyan-500" />
                  <span className="text-xl font-semibold tracking-wide">
                    Home<span className="text-cyan-600">Hunt</span>
                  </span>
                </a>
              </Link>
              <div className="flex items-center space-x-4">
                ...
                {isLoadingUser ? (
                  ...
                  <button
                    type="button"
                    onClick={openModal}
                    className="ml-4 px-4 py-1 rounded-md bg-cyan-600 hover:bg-cyan-500 focus:outline-none focus:ring-4 focus:ring-cyan-500 focus:ring-opacity-50 text-white transition"
                  >
                    Log in
                  </button>
                )}
